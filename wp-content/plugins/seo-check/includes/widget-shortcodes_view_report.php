...
class seocheck_view_report_widget extends WP_Widget {
    ...
    function __construct() {  
	 $widget_ops = array( 'classname' => 'eranker-plugin-widget', 'description' => 'Seo Checker widget' );
        parent::__construct('eranker-plugin-widget', 'SEO Toolbox: View Report', $widget_ops );
    }
