            ...
            <tr class="row_even seocheck_bglgray">
                <td class="seocheck_nobg" colspan="2">
                    ...
                    <span id="seocheck_eranker_selectall" style="font-size: 12px; font-weight: normal;float: right; cursor: pointer">
                        <a rel="nofollow" href="javascript:jQuery('.seocheck_newreport input[name^=factorsGroup]').prop('checked', true);jQuery('.seocheck_newreport #seocheck_eranker_selectall').hide();jQuery('.seocheck_newreport #seocheck_eranker_deselectall').show();">
                    ...
                    <span id="seocheck_eranker_deselectall" style="font-size: 12px; font-weight: normal;float: right; cursor: pointer; display: none;">
                        <a rel="nofollow" href="javascript:jQuery('.seocheck_newreport input[name^=factorsGroup]').prop('checked', false);jQuery('.seocheck_newreport #seocheck_eranker_selectall').show();jQuery('.seocheck_newreport #seocheck_eranker_deselectall').hide();">
                    ...
                    if (!empty($allfactor_list)) {												
                        foreach ($allfactor_list as $key => $value) {
                            ...
                            <label class="factor_list_checkbox" title="" for="factor_<?PHP echo $key ?>">
                                <input id="factor_<?PHP echo $key ?>" type="checkbox" name="factorsGroup[]" <?PHP echo $is_checked ? 'checked="checked"' : '' ?> value="<?PHP echo $key ?>"><?PHP echo ucfirst($value->friendly_name) ?>
                            </label>
                        <?php } ?> 
                    </td>
                </tr>
