    ...
    <div class="er_plugin seocheck_page_settings">
        ...
        <?PHP if (empty($accountinfo) || isset($accountinfo->debug)) { ?>
            ...
            <div class="seocheck_box" id="seocheck_box_info">
                ...
                <a class="button-secondary seocheck_floatingrigthbuttontop" href="http://www.eranker.com/register/" rel="nofollow" target="_blank"><strong><?php _e('Setup your free account', 'er'); ?></strong></a>
                <p>
                    <?php printf(__('To be able to use this plugin you first of all need to create a free account at %s.', 'er'), '<a rel="nofollow" href="http://www.eranker.com/register" target="_blank">http://www.eranker.com/</a>'); ?>
            ...
            <div class="seocheck_box" id="seocheck_box_info">
                ...
                <a class="button-secondary seocheck_floatingrigthbuttontop" href="http://www.eranker.com/login/" rel="nofollow" target="_blank"><strong><?php _e('Visit your eRanker account', 'er'); ?></strong> </a>
                <p>
            ...
            <div class="widget seocheck_widget">
                <div class="widget-top seocheck_nomovecursor">
                    <div class="widget-title">
                        <a class="seocheck_floatrigth seocheck_mariginleft" href="http://www.eranker.com/settings" rel="nofollow" target="_blank"><?php _e('Click here to create and view your API Credentials', 'er'); ?></a>
                ...
                <div class="widget-inside seocheck_nopadding" style="display: block;">
                    <form method="post" action="admin.php?page=seocheck_page_settings">
                        <table class="form-table seocheck_table seocheck_noborder seocheck_nomargin">
							...
							<tr class="row_even seocheck_bglgray">
                                <td class="row_multi seocheck_nobg" style="width:200px">
                                    <label for="seocheck_settings_api_key"><?php _e('Report Language', 'er'); ?>:</label>
                                </td>
                                <td class="seocheck_nobg">
								<select id="seocheck_layout" id="seocheck_settings_report_language" name="seocheck_settings[report_language]">
                                    <option value="en" <?php echo (!isset($seocheck_settings['report_language']) || strcasecmp('en', trim($seocheck_settings['report_language'])) === 0 ) ? 'selected="selected"' : ''; ?> >EN</option>
                                    <option value="de" <?php echo (isset($seocheck_settings['report_language']) && strcasecmp('de', trim($seocheck_settings['report_language'])) === 0 ) ? 'selected="selected"' : ''; ?> >DE</option>
                                </select>                                   
                                </td>
                            </tr>    							
                        </table>
                ...
                <div class="widget-top seocheck_nomovecursor">
                    <div class="widget-title">                       
                        <h4 ><?php _e('API account status', 'er'); ?> <span class="in-widget-title"></span>
                            <a style="font-size: 12px;" class="seocheck_floatrigth seocheck_mariginleft" href="http://www.eranker.com/settings" rel="nofollow" target="_blank"><?php _e('Account Settings at eRanker', 'er'); ?> <img src="<?PHP echo plugins_url(SEOCHECK_FOLDERNAME . '/images/icon-new-window.gif') ?>" alt="" /></a>
                        </h4>
                    </div>
                </div>
                <div class="widget-inside seocheck_nopadding" style="display: block;">
                        ...
                        <table class="form-table seocheck_table seocheck_noborder seocheck_nomargin">
                            ...
                            <tr class="row_even seocheck_bglgray">
                                ...
                                <td class="seocheck_nobg">
                                    ...
                                    ?>
                                    <a href="http://www.eranker.com/plans" rel="nofollow" target="_blank"><img src="<?PHP echo plugins_url(SEOCHECK_FOLDERNAME . '/images/' . $medalimg) ?>" alt="" class="seocheck_floatleft seocheck_mariginright"/></a>
                                    <a href="http://www.eranker.com/plans" rel="nofollow" target="_blank" style="text-decoration: none"><h3 style="height: 20px;margin: 0;padding: 0;color: <?php echo $planamecolor; ?>;"><?php echo $accountinfo->plan->display_name; ?> <img src="<?PHP echo plugins_url(SEOCHECK_FOLDERNAME . '/images/icon-new-window.gif') ?>" alt="" /></h3></a>
                                    Renew: <?php echo $accountinfo->plan->expiration; ?>
                                </td>
                            </tr> 
							<tr class="row_even seocheck_bglgray">
                                <td class="row_multi seocheck_nobg" style="width:200px">
                                    <?php _e('Report Language', 'er'); ?>:
                                </td>
                                <td class="seocheck_nobg">
                                   <select disabled id="seocheck_layout" id="seocheck_settings_report_language" name="seocheck_settings[report_language]">
                                    <option value="POPUP" <?php echo (!isset($seocheck_settings['report_language']) || strcasecmp('en', trim($seocheck_settings['report_language'])) === 0 ) ? 'selected="selected"' : ''; ?> >EN</option>
                                    <option value="FOOTER" <?php echo (isset($seocheck_settings['report_language']) && strcasecmp('de', trim($seocheck_settings['report_language'])) === 0 ) ? 'selected="selected"' : ''; ?> >DE</option>
                                </select>  
                                </td>
                            </tr> 
                        </table>
        ...
        <div class="seocheck_box" id="seocheck_box_help">
            ...
            <ul>
                <li><?php printf(__('<a target="_blank" rel="nofollow" href="%s">Read the online documentation</a> and our <a target="_blank" href="%s">Blog</a> for more information about this plugin', 'er'), 'http://www.eRanker.com/wordpress-plugin/', 'http://www.eRanker.com/blog/'); ?>;</li>
                <li><?php printf(__('<a target="_blank" rel="nofollow" href="%s">Contact us</a> if you have feedback or need assistance', 'er'), 'http://www.eRanker.com/contact/'); ?>;   </li>   
                <li><?php printf(__('Do you want <strong>develop your own plugins</strong> using eRanker API? <a target="_blank" href="%s" rel="nofollow">See our API documentation</a>', 'er'), 'http://www.eRanker.com/api/'); ?>.</li>
            </ul>
        </div>
    </div>
</div>